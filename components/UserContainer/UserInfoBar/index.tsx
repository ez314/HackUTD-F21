...
export default function UserInfoBar({ user, setProfile }: UserInfoBarProps) {
  return (
    <div id="userinfobar" className="flex flex-row items-center m-0 p-0 w-full h-16 bg-custom-gray-0">
      {user ? <div className="flex flex-row items-center w-full">
        <ProfileIcon className="w-6 h-6 mx-3 cursor-pointer hover:scale-110 hover:text-custom-blue transition" onClick={() => {
          setProfile(true)
        }
        }/>
